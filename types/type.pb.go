...
func NewPopulatedType(r randyType, easy bool) *Type {
	...
	if r.Intn(10) != 0 {
		this.SourceContext = google_protobuf1.NewPopulatedSourceContext(r, easy)
	}
...
func NewPopulatedOption(r randyType, easy bool) *Option {
	...
	this.Name = string(randStringType(r))
	if r.Intn(10) != 0 {
		this.Value = google_protobuf.NewPopulatedAny(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (this *Type) String() string {
	...
	s := strings.Join([]string{`&Type{`,
		...
		`SourceContext:` + strings.Replace(fmt.Sprintf("%v", this.SourceContext), "SourceContext", "google_protobuf1.SourceContext", 1) + `,`,
...
func (this *Option) String() string {
	...
	s := strings.Join([]string{`&Option{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Value:` + strings.Replace(fmt.Sprintf("%v", this.Value), "Any", "google_protobuf.Any", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func init() { proto.RegisterFile("type.proto", fileDescriptorType) }

var fileDescriptorType = []byte{
	// 838 bytes of a gzipped FileDescriptorProto
	,
}
