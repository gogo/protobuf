...
func (m *Api) GetSyntax() google_protobuf2.Syntax {
	...
	return google_protobuf2.SYNTAX_PROTO2
}
...
func NewPopulatedApi(r randyApi, easy bool) *Api {
	...
	if r.Intn(10) != 0 {
		v2 := r.Intn(5)
		this.Options = make([]*google_protobuf2.Option, v2)
		for i := 0; i < v2; i++ {
			this.Options[i] = google_protobuf2.NewPopulatedOption(r, easy)
		}
	}
	this.Version = string(randStringApi(r))
	if r.Intn(10) != 0 {
		this.SourceContext = google_protobuf.NewPopulatedSourceContext(r, easy)
	}
	if r.Intn(10) != 0 {
		v3 := r.Intn(5)
	...
	this.Syntax = google_protobuf2.Syntax([]int32{0, 1}[r.Intn(2)])
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedMethod(r randyApi, easy bool) *Method {
	...
	if r.Intn(10) != 0 {
		v4 := r.Intn(5)
		this.Options = make([]*google_protobuf2.Option, v4)
		for i := 0; i < v4; i++ {
			this.Options[i] = google_protobuf2.NewPopulatedOption(r, easy)
		}
	}
...
func (this *Api) String() string {
	...
	s := strings.Join([]string{`&Api{`,
		...
		`Options:` + strings.Replace(fmt.Sprintf("%v", this.Options), "Option", "google_protobuf2.Option", 1) + `,`,
		`Version:` + fmt.Sprintf("%v", this.Version) + `,`,
		`SourceContext:` + strings.Replace(fmt.Sprintf("%v", this.SourceContext), "SourceContext", "google_protobuf.SourceContext", 1) + `,`,
...
var fileDescriptorApi = []byte{
	...
	,
}
