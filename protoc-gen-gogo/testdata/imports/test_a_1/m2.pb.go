...
func (*M2) Descriptor() ([]byte, []int) { return fileDescriptorM2, []int{0} }
...
func init() { proto.RegisterFile("imports/test_a_1/m2.proto", fileDescriptorM2) }

var fileDescriptorM2 = []byte{
