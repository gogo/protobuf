...
func (*M1) Descriptor() ([]byte, []int) { return fileDescriptorM1, []int{0} }
...
func init() { proto.RegisterFile("imports/test_a_1/m1.proto", fileDescriptorM1) }

var fileDescriptorM1 = []byte{
