...
func (*Public) Descriptor() ([]byte, []int) { return fileDescriptorTestImportPublic, []int{0} }
...
func init() { proto.RegisterFile("imports/test_import_public.proto", fileDescriptorTestImportPublic) }

var fileDescriptorTestImportPublic = []byte{
