...
func (*A1M2) Descriptor() ([]byte, []int) { return fileDescriptorTestImportA1M2, []int{0} }
...
func init() { proto.RegisterFile("imports/test_import_a1m2.proto", fileDescriptorTestImportA1M2) }

var fileDescriptorTestImportA1M2 = []byte{
