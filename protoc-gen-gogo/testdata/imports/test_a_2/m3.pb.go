...
func (*M3) Descriptor() ([]byte, []int) { return fileDescriptorM3, []int{0} }
...
func init() { proto.RegisterFile("imports/test_a_2/m3.proto", fileDescriptorM3) }

var fileDescriptorM3 = []byte{
