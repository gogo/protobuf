...
func (*M4) Descriptor() ([]byte, []int) { return fileDescriptorM4, []int{0} }
...
func init() { proto.RegisterFile("imports/test_a_2/m4.proto", fileDescriptorM4) }

var fileDescriptorM4 = []byte{
