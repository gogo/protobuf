...
func (Request_Flavour) EnumDescriptor() ([]byte, []int) { return fileDescriptorProto3, []int{0, 0} }
...
func (*Request) Descriptor() ([]byte, []int) { return fileDescriptorProto3, []int{0} }
...
func (*Book) Descriptor() ([]byte, []int) { return fileDescriptorProto3, []int{1} }
...
func init() { proto.RegisterFile("proto3/proto3.proto", fileDescriptorProto3) }
