...
func (*ForeignImportedMessage) Descriptor() ([]byte, []int) { return fileDescriptorImp3, []int{0} }
...
func init() { proto.RegisterFile("imp/imp3.proto", fileDescriptorImp3) }

var fileDescriptorImp3 = []byte{
