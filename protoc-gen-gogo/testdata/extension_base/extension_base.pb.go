...
func (*BaseMessage) Descriptor() ([]byte, []int) { return fileDescriptorExtensionBase, []int{0} }
...
func (*OldStyleMessage) Descriptor() ([]byte, []int) { return fileDescriptorExtensionBase, []int{1} }
...
func init() { proto.RegisterFile("extension_base/extension_base.proto", fileDescriptorExtensionBase) }

var fileDescriptorExtensionBase = []byte{
