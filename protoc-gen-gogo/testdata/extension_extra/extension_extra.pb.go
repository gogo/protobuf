...
func (*ExtraMessage) Descriptor() ([]byte, []int) { return fileDescriptorExtensionExtra, []int{0} }
...
func init() { proto.RegisterFile("extension_extra/extension_extra.proto", fileDescriptorExtensionExtra) }

var fileDescriptorExtensionExtra = []byte{
