...
type B struct {
	String_          *string `protobuf:"bytes,1,opt" json:"String,omitempty"`
	Int64            *int64  `protobuf:"varint,2,opt" json:"Int64,omitempty"`
	Int32            *int32  `protobuf:"varint,3,opt,def=1234" json:"Int32,omitempty"`
