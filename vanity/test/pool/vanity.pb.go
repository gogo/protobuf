...
func (*A) Descriptor() ([]byte, []int) {
	return fileDescriptor_vanity_c6eb52dda709f0e6, []int{0}
}
...
func (m *A) MarshalPool() (*github_com_gogo_protobuf_mem.Bytes, error) {
	size := m.Size()
...
func GetA() *A {
	...
	return globalAObjectPool.Get().(*A)
}
...
func (m *A) Recycle() {
	...
	globalAObjectPool.Put(m)
}

func newA() github_com_gogo_protobuf_mem.Object {
	return &A{}
}

var (
	globalAObjectPool = github_com_gogo_protobuf_mem.NewObjectPool(newA)
)

func init() {
	github_com_gogo_protobuf_mem.RegisterGlobalObjectPool(
		func() *github_com_gogo_protobuf_mem.ObjectPool { return globalAObjectPool },
		func(options ...github_com_gogo_protobuf_mem.ObjectPoolOption) {
			globalAObjectPool = github_com_gogo_protobuf_mem.NewObjectPool(newA, options...)
		},
	)
}
...
func init() { proto.RegisterFile("vanity.proto", fileDescriptor_vanity_c6eb52dda709f0e6) }

var fileDescriptor_vanity_c6eb52dda709f0e6 = []byte{
	...
	0xe6, 0x95, 0x48, 0x30, 0x29, 0x30, 0x69, 0x30, 0x43, 0xe5, 0x40, 0x02, 0x4e, 0x06, 0x17, 0x1e,
	...
	0x46, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xe2, 0x50, 0x39, 0x80, 0x85, 0x00, 0x00, 0x00,
}
