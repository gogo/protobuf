...
func (*Aproto3) Descriptor() ([]byte, []int) {
	return fileDescriptor_proto3_82217fbcee93a56d, []int{0}
}
...
func (m *Aproto3) MarshalPool() (*github_com_gogo_protobuf_mem.Bytes, error) {
	size := m.Size()
...
// GetAproto3 gets a reset *Aproto3.
func GetAproto3() *Aproto3 {
	if !github_com_gogo_protobuf_mem.PoolingEnabled() {
		return &Aproto3{}
	}
	return globalAproto3ObjectPool.Get().(*Aproto3)
}
...
func (m *Aproto3) Recycle() {
	...
	globalAproto3ObjectPool.Put(m)
}

func newAproto3() github_com_gogo_protobuf_mem.Object {
	return &Aproto3{}
}

var (
	globalAproto3ObjectPool = github_com_gogo_protobuf_mem.NewObjectPool(newAproto3)
)

func init() {
	github_com_gogo_protobuf_mem.RegisterGlobalObjectPool(
		func() *github_com_gogo_protobuf_mem.ObjectPool { return globalAproto3ObjectPool },
		func(options ...github_com_gogo_protobuf_mem.ObjectPoolOption) {
			globalAproto3ObjectPool = github_com_gogo_protobuf_mem.NewObjectPool(newAproto3, options...)
		},
	)
}
...
func init() { proto.RegisterFile("proto3.proto", fileDescriptor_proto3_82217fbcee93a56d) }

var fileDescriptor_proto3_82217fbcee93a56d = []byte{
	...
	0x46, 0x27, 0x27, 0x83, 0x0b, 0x0f, 0xe5, 0x18, 0x6e, 0x3c, 0x94, 0x63, 0xf8, 0xf0, 0x50, 0x8e,
	...
	0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0x63, 0x12, 0x1b, 0xc4, 0x1c, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x78, 0x28, 0x58, 0x94, 0x69, 0x00, 0x00, 0x00,
}
