...
// source: combos/unsafeborrowunmarshaler/types.proto
// DO NOT EDIT!
...
/*
	...
	It is generated from these files:
		combos/unsafeborrowunmarshaler/types.proto
...
func (m *KnownTypes) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowTypesBorrowUnsafe
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthTypesBorrowUnsafe
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipTypesBorrowUnsafe(data[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipTypesBorrowUnsafe(data []byte) (n int, err error) {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowTypesBorrowUnsafe
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthTypesBorrowUnsafe
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipTypesBorrowUnsafe(data[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthTypesBorrowUnsafe = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowTypesBorrowUnsafe   = fmt.Errorf("proto: integer overflow")
)

func init() { proto.RegisterFile("combos/unsafeborrowunmarshaler/types.proto", fileDescriptorTypes) }

var fileDescriptorTypes = []byte{
	// 927 bytes of a gzipped FileDescriptorProto
	,
}
