...
func NewPopulatedDropped(r randyThetest, easy bool) *Dropped {
	this := &Dropped{}
	this.Name = string(randStringThetest(r))
...
func NewPopulatedKept(r randyThetest, easy bool) *Kept {
	this := &Kept{}
	this.Name = string(randStringThetest(r))
	this.Age = int32(r.Int31())
	if r.Intn(2) == 0 {
...
var fileDescriptorThetest = []byte{
	...
	0xc3, 0xc5, 0xe2, 0x9d, 0x5a, 0x50, 0x42, 0x9c, 0x1e, 0x27, 0x9d, 0x07, 0x0f, 0xe5, 0x18, 0x7f,
	0x3c, 0x94, 0x63, 0x5c, 0xf1, 0x48, 0x8e, 0x71, 0xc7, 0x23, 0x39, 0xc6, 0x03, 0x8f, 0xe4, 0x18,
	0x4f, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x1f, 0x8f, 0xe4,
	0x18, 0x1a, 0x1e, 0xcb, 0x31, 0xcc, 0x78, 0x2c, 0xc7, 0x90, 0xc4, 0x06, 0x76, 0x99, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0x56, 0x45, 0xe8, 0x23, 0xee, 0x00, 0x00, 0x00,
}
