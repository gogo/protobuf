...
func GroupDescription() (desc *descriptor.FileDescriptorSet) {
	return &descriptor.FileDescriptorSet{File: []*descriptor.FileDescriptorProto{{Name: func(v string) *string { return &v }("google/protobuf/descriptor.proto"),
		...
		MessageType: []*descriptor.DescriptorProto{{Name: func(v string) *string { return &v }("Groups1"),
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("g"),
				Number:   func(v int32) *int32 { return &v }(1),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(3),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(10),
				TypeName: func(v string) *string { return &v }(".group.Groups1.G"),
				JsonName: func(v string) *string { return &v }("g"),
			}},
			NestedType: []*descriptor.DescriptorProto{{Name: func(v string) *string { return &v }("G"),
		...
		}, {Name: func(v string) *string { return &v }("Groups2"),
			Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("g"),
				Number:   func(v int32) *int32 { return &v }(1),
				Label:    func(v descriptor.FieldDescriptorProto_Label) *descriptor.FieldDescriptorProto_Label { return &v }(1),
				Type:     func(v descriptor.FieldDescriptorProto_Type) *descriptor.FieldDescriptorProto_Type { return &v }(10),
				TypeName: func(v string) *string { return &v }(".group.Groups2.G"),
				JsonName: func(v string) *string { return &v }("g"),
			}},
			NestedType: []*descriptor.DescriptorProto{{Name: func(v string) *string { return &v }("G"),
				Field: []*descriptor.FieldDescriptorProto{{Name: func(v string) *string { return &v }("Field1"),
		...
		Options: &descriptor.FileOptions{XXX_extensions: map[int32]proto.Extension{63001: proto.NewExtension([]byte{0xc8, 0xe1, 0x1e, 0x0}), 63002: proto.NewExtension([]byte{0xd0, 0xe1, 0x1e, 0x0}), 63003: proto.NewExtension([]byte{0xd8, 0xe1, 0x1e, 0x0}), 63004: proto.NewExtension([]byte{0xe0, 0xe1, 0x1e, 0x1}), 63006: proto.NewExtension([]byte{0xf0, 0xe1, 0x1e, 0x1}), 63007: proto.NewExtension([]byte{0xf8, 0xe1, 0x1e, 0x1}), 63008: proto.NewExtension([]byte{0x80, 0xe2, 0x1e, 0x1}), 63013: proto.NewExtension([]byte{0xa8, 0xe2, 0x1e, 0x1}), 63014: proto.NewExtension([]byte{0xb0, 0xe2, 0x1e, 0x1}), 63015: proto.NewExtension([]byte{0xb8, 0xe2, 0x1e, 0x1}), 63017: proto.NewExtension([]byte{0xc8, 0xe2, 0x1e, 0x0}), 63018: proto.NewExtension([]byte{0xd0, 0xe2, 0x1e, 0x0}), 63020: proto.NewExtension([]byte{0xe0, 0xe2, 0x1e, 0x0})}},
	}},
	}
}
