...
func (m *Castaway) MarshalTo(data []byte) (int, error) {
	...
	if m.MyFloat32Ptr != nil {
		data[i] = 0x2d
		i++
		i = encodeFixed32Casttype(data, i, uint32(math.Float32bits(*m.MyFloat32Ptr)))
	}
	data[i] = 0x35
	i++
	i = encodeFixed32Casttype(data, i, uint32(math.Float32bits(m.MyFloat32)))
	if m.MyFloat64Ptr != nil {
		data[i] = 0x39
		i++
		i = encodeFixed64Casttype(data, i, uint64(math.Float64bits(*m.MyFloat64Ptr)))
	}
	data[i] = 0x41
	i++
	i = encodeFixed64Casttype(data, i, uint64(math.Float64bits(m.MyFloat64)))
	if m.MyBytes != nil {
		data[i] = 0x4a
		i++
