...
type RepStdTypes struct {
	Timestamps []*time.Time `protobuf:"bytes,3,rep,name=timestamps,stdtime" json:"timestamps,omitempty"`
}
...
func (this *RepStdTypes) String() string {
	...
	s := strings.Join([]string{`&RepStdTypes{`,
		`Timestamps:` + strings.Replace(fmt.Sprintf("%v", this.Timestamps), "Timestamp", "google_protobuf1.Timestamp", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *RepStdTypes) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Timestamps = append(m.Timestamps, new(time.Time))
...
var fileDescriptorIssue261 = []byte{
	...
	0x28, 0x50, 0xf2, 0xe7, 0xe2, 0x0e, 0x4a, 0x2d, 0x08, 0x2e, 0x49, 0x09, 0xa9, 0x2c, 0x48, 0x2d,
	0x16, 0x72, 0xe0, 0xe2, 0x82, 0xab, 0x28, 0x96, 0x60, 0x56, 0x60, 0xd6, 0xe0, 0x36, 0x92, 0xd2,
	0x83, 0x18, 0xa2, 0x07, 0x33, 0x44, 0x2f, 0x04, 0xa6, 0xc4, 0x89, 0x65, 0xc2, 0x7d, 0x79, 0xc6,
	0x20, 0x24, 0x3d, 0x4e, 0x3a, 0x17, 0x1e, 0xca, 0x31, 0xdc, 0x78, 0x28, 0xc7, 0xf0, 0xe1, 0xa1,
	...
	0xf0, 0x58, 0x8e, 0x21, 0x89, 0x0d, 0x6c, 0xa6, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x26, 0xb1,
	0x71, 0xda, 0xf1, 0x00, 0x00, 0x00,
}
