...
func (m *StdTypes) MarshalTo(dAtA []byte) (int, error) {
	...
	n1, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Duration, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n1
...
func (this *StdTypes) String() string {
	...
	s := strings.Join([]string{`&StdTypes{`,
		`Duration:` + strings.Replace(strings.Replace(this.Duration.String(), "Duration", "google_protobuf1.Duration", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorIssue261 = []byte{
	...
	0x2b, 0x79, 0x73, 0x71, 0x04, 0x97, 0xa4, 0x84, 0x54, 0x16, 0xa4, 0x16, 0x0b, 0xd9, 0x73, 0x71,
	0xc0, 0x64, 0x25, 0x58, 0x14, 0x18, 0x35, 0xb8, 0x8d, 0x24, 0xf5, 0x20, 0xda, 0xf5, 0x60, 0xda,
	0xf5, 0x5c, 0xa0, 0x0a, 0x9c, 0x38, 0x4e, 0xdc, 0x93, 0x67, 0x98, 0x71, 0x5f, 0x9e, 0x31, 0x08,
	0xae, 0xc9, 0x49, 0xe7, 0xc2, 0x43, 0x39, 0x86, 0x1b, 0x0f, 0xe5, 0x18, 0x3e, 0x3c, 0x94, 0x63,
	...
	0xcb, 0x31, 0x24, 0xb1, 0x81, 0x0d, 0x35, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xc6, 0x17, 0x65,
	0x15, 0xec, 0x00, 0x00, 0x00,
}
