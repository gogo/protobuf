...
type MapStdTypes struct {
	Duration map[int32]*time.Duration `protobuf:"bytes,4,rep,name=duration,stdduration" json:"duration,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (this *MapStdTypes) Equal(that interface{}) bool {
	...
	for i := range this.Duration {
		if dthis, dthat := this.Duration[i], that1.Duration[i]; (dthis != nil && dthat != nil && *dthis != *dthat) || (dthis != nil && dthat == nil) || (dthis == nil && dthat != nil) {
			return false
		}
	}
	return true
...
var fileDescriptorIssue261 = []byte{
	...
	0x2b, 0xad, 0x61, 0xe4, 0xe2, 0xf6, 0x4d, 0x2c, 0x08, 0x2e, 0x49, 0x09, 0xa9, 0x2c, 0x48, 0x2d,
	0x16, 0x72, 0xe5, 0xe2, 0x80, 0xa9, 0x90, 0x60, 0x51, 0x60, 0xd6, 0xe0, 0x36, 0x52, 0xd6, 0x83,
	0xbb, 0x05, 0x49, 0xa1, 0x9e, 0x0b, 0x54, 0x95, 0x6b, 0x5e, 0x49, 0x51, 0xa5, 0x13, 0xcb, 0x8c,
	0xfb, 0xf2, 0x8c, 0x41, 0x70, 0xad, 0x52, 0x61, 0x5c, 0xbc, 0x28, 0x0a, 0x84, 0x04, 0xb8, 0x98,
	0xb3, 0x53, 0x2b, 0x25, 0x18, 0x15, 0x18, 0x35, 0x58, 0x83, 0x40, 0x4c, 0x21, 0x7d, 0x2e, 0xd6,
	0xb2, 0xc4, 0x9c, 0xd2, 0x54, 0x09, 0x26, 0x05, 0x46, 0x0d, 0x6e, 0x23, 0x49, 0x3d, 0x88, 0x4b,
	0xf5, 0x60, 0x2e, 0x85, 0xdb, 0x10, 0x04, 0x51, 0x67, 0xc5, 0x64, 0xc1, 0xe8, 0xa4, 0x73, 0xe1,
	...
	0x66, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x2d, 0xeb, 0xc7, 0x2c, 0x4e, 0x01, 0x00, 0x00,
}
