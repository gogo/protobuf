...
type OneofStdTypes_Timestamp struct {
	Timestamp int64 `protobuf:"varint,1,opt,name=timestamp,proto3,oneof"`
}
...
func (m *OneofStdTypes) GetTimestamp() int64 {
...
func _OneofStdTypes_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // OneOfStdTimes.timestamp
		...
		m.OneOfStdTimes = &OneofStdTypes_Timestamp{int64(x)}
		return true, err
...
func (m *OneofStdTypes_Timestamp) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintIssue261(dAtA, i, uint64(m.Timestamp))
	return i, nil
}
func (m *OneofStdTypes_Duration) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Duration != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintIssue261(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.Duration)))
...
func (m *OneofStdTypes_Timestamp) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovIssue261(uint64(m.Timestamp))
	return n
}
...
var fileDescriptorIssue261 = []byte{
	...
	0x2b, 0xd5, 0x73, 0xf1, 0xfa, 0xe7, 0xa5, 0xe6, 0xa7, 0x05, 0x97, 0xa4, 0x84, 0x54, 0x16, 0xa4,
	0x16, 0x0b, 0xc9, 0x71, 0x71, 0x96, 0x64, 0xe6, 0xa6, 0x16, 0x97, 0x24, 0xe6, 0x16, 0x48, 0x30,
	0x2a, 0x30, 0x6a, 0x30, 0x7b, 0x30, 0x04, 0x21, 0x84, 0x84, 0x6c, 0xb9, 0x38, 0x60, 0x46, 0x48,
	0x30, 0x29, 0x30, 0x6a, 0x70, 0x1b, 0x49, 0xea, 0x41, 0xec, 0xd0, 0x83, 0xd9, 0xa1, 0xe7, 0x02,
	0x55, 0xe0, 0xc4, 0x32, 0xe3, 0xbe, 0x3c, 0xa3, 0x07, 0x43, 0x10, 0x5c, 0x8b, 0x13, 0x3f, 0xd8,
	0x3e, 0x7f, 0xb0, 0x7d, 0x20, 0x33, 0x9d, 0x74, 0x2e, 0x3c, 0x94, 0x63, 0xb8, 0xf1, 0x50, 0x8e,
	...
	0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0xd8, 0x0e, 0x63, 0x40, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xe6, 0x45, 0xfa, 0x1b, 0x20, 0x01, 0x00, 0x00,
}
